...
public class ApiTests {
    ...
    public void getAllPostsByUser() {
        ...
        logger.info("Response length: " + responseBody.length);
        logger.info("Title of the first post: " + responseBody[0].getTitle());
        logger.info("Author name of the second post: " + responseBody[1].getAuthor().getUsername());

        for (int i = 0; i < responseBody.length; i++) {
            Assert.assertEquals("Author username", "autoapi", responseBody[i].getAuthor().getUsername());
        }

        // good approach - to compare our Actual Object and Expected Object PostDTO
    ...
    public void getAllPostsByUserPath(){
        ...
        for (int i = 0; i < titleList.size(); i++) {
            softAssertions.assertThat(titleList.get(i))
