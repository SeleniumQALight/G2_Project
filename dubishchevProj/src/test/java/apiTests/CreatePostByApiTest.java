...
public class CreatePostByApiTest {
    ...
    public void createNewPostByApi() {
        ...
        requestParams.put("title", "New post frop API by Oleh");
        requestParams.put("body", "Some body text");
        ...
        Assert.assertEquals("Number of posts not equals", 1, actualPostDTO.length);
