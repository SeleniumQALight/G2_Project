...
public class CreatePostByApiTest {
    final String userName = "kulevskyi";
    final String passWord = "deniSKAA9210908383";
    ...
    @Test public void createNewPostByApi(){
        String token = apiHelper.getToken(userName,passWord);

        JSONObject requestParams = new JSONObject();
        requestParams.put("title", "New post from API Kulevskyi");
        ...
        Assert.assertEquals("Massege", "\"Congrats.\"", response);
