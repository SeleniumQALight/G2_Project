...
public class CreatePostByApiTest {
    final String userName = "testiren";
    final String passWord = "qwerty12345678";
    ApiHelper apiHelper = new ApiHelper();

    @Before
    public  void  deleteAllPosts(){
        //login, get all posts, delete
    ...
    public  void createNewPOstByApi() {
        ...
        // verify N-s of  actual posts
        Assert.assertEquals("Number of posts", 1, actualPostDTO.length);
        // verify if the Post has correct data
