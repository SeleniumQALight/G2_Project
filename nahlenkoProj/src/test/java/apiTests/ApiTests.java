...
public class ApiTests {
    ...
    public void getAllPostsByUser() {
        PostDTO[] responseBody = given()
                ...
                .filter(new AllureRestAssured())//для отображения в отчете детализации
                .log().all()
                .when()
        ...
        logger.info(responseBody[0].getAuthor());
    ...
    public void getAllPostByUserNegative (){
        ...
        Assert.assertEquals("Message ","\"Sorry, invalid user requested.undefined\"", responseBody);
    }
    @Test
    public void getAllPostsByUserPath (){ //equals validation
    ...
    @Test
    public void getAllPostsByUserSchema(){//schema validation
        given()
                .contentType(ContentType.JSON)
                .log().all()
                .when()
