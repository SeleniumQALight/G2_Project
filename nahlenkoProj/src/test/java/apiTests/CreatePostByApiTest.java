...
public class CreatePostByApiTest {
    final String userName = "viktoriiap";
    final String passWord = "Qwerty7777777";
    ...
    public void createNewPostByApi() {
        ...
        Assert.assertEquals("Number of posts", 1, actualPostDTO.length);//проверка что новый пост создался -к-во

        PostDTO[]expectedPostDTO={
                new PostDTO(
                      requestParams.getString("title"),// переиспользуем с реквеста так как там задавали значение
