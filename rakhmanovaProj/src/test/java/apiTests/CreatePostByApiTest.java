...
public class CreatePostByApiTest {
    final String userName = "tetianar";
    final String passWord = "1qazxcvbnm99";
    ...
    public void createNewPostByApi(){
        ...
        requestParams.put("title", "New post from API Tetiana");
        requestParams.put("body", "post body");
        requestParams.put("select1", "One person"); // one person - we take it from Back End -> from value
        ...
        Assert.assertEquals("Some message", "\"Congrats.\"", response);
