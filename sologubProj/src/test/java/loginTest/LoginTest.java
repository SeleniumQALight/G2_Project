...
public class LoginTest {
    ...
    public void invalidLogin() {
        ...
        webDriver.findElement(By.xpath(".//input[@placeholder='Username']")).clear();
        webDriver.findElement(By.xpath(".//input[@placeholder='Username']")).sendKeys("auto123");
        System.out.println("'auto' was inputted");
        ...
        Assert.assertTrue("Alert text is not visible", isAlertTextIsVisible());
    ...
    public boolean isAlertTextIsVisible() {
        try {
