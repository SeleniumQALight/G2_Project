...
public class APITests {
    ...
    public void getAllPostsByUser() {
        ...
        .then()
                ...
                ;
//        logger.info("Length = " + responseBody.length);
...
//        }
    ...
    @Test
    public void getAllPostsByInvalidUser() {
        String responseBody =
                given()
                        .contentType(ContentType.JSON)
                        .log().all()
    ...
    public void getAllPostsByUserPath() {
        ...
        for (int i = 0; i < titleList.size(); i++) {
            softAssertions.assertThat(titleList.get(i)).as("Title item number " + i).contains("test");
            softAssertions.assertThat(authorList.get(i).get("username")).as("Author item number " + i).isEqualTo(USER_NAME);
        }
        softAssertions.assertAll();
    }
