...
public class CreatePostByApiTest {
    final String userName = "vorkoff";
    final String password = "1233213vorkoff";
    ...
    @After
    public void deleteAllPostsAfter() {
        apiHelper.deletePostsTillPresent(userName, password);
    ...
    public void createNewPostByApi() {
        ...
        requestParams.put("title", "New post from API by YN 2");
        requestParams.put("body", "Post body from API by YN 2");
